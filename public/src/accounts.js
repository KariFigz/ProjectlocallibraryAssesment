...
//map through the accounts data(object) that loops through the array and from it we put toghether first and last name 
//For Ex:`<firstName> <lastName>` only done with strings
